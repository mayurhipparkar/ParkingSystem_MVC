        ...
        <div class="col-12 col-md-10 col-lg-8">
            <div class="card shadow-lg border-0">
                <div class="card-header  bg-primary text-white text-center">
                    <h4 class="mb-0">Set Parking Fee</h4>
                </div>

                <div class="card-body">
                    <form action="${pageContext.request.contextPath}/parking/save-parking-fee" method="post">

                        <!-- Vehicle Type -->
                        <div class="form-group mb-4">
                            <label class="form-label">Vehicle Type</label><br>
                            <div class="form-check form-check-inline">
                                <input type="radio" id="twoWheeler" name="vehicleType" value="two Wheeler" class="form-check-input" required>
