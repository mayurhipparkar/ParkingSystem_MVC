...
public class EnteredVehicleList {
	...
	Map<String, Object> response =enteredVehicleListInterface.getVehicleListByType( vehicleType, page, size, search, entryDate, sessionUserId, sessionUserRole);
	...
	public String fourWheelerList(@PathVariable String vehicleType,
	    ...
	    Map<String, Object> response = enteredVehicleListInterface.getVehicleListByType(
	            vehicleType, page, size, search, entryDate, sessionUserId, sessionUserRole);
